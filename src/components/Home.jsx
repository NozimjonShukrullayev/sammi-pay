  ...
  return (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 relative`}>
        ...
        {/* Description */}
        <p className={`${styles.paragraph} mt-5 max-w-[550px]`}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sint quis incidunt consequuntur aut voluptate quisquam ipsum, similique deleniti perspiciatis nihil?</p>
        ...
        <div className="absolute z-[0] w-[50%] h-[55%] right-20 bottom-20 top-0 blue-gradient" />
      </div>
    </section>
  )
}
